...
def main() -> None:
    ...
    try:
        job_run_id = start_job_run(
            ...
            metadata_json={
                "bucket": MINIO_BUCKET,
                "request_timeout_seconds": GLEIF_REQUEST_TIMEOUT_SECONDS,
                "chunk_size_bytes": GLEIF_CHUNK_SIZE_BYTES,
                "max_retries": GLEIF_MAX_RETRIES,
                "retry_sleep_seconds": GLEIF_RETRY_SLEEP_SECONDS,
                "download_lei_full": GLEIF_DOWNLOAD_LEI_FULL,
                "download_lei_delta_lastday": GLEIF_DOWNLOAD_LEI_DELTA_LASTDAY,
                "download_rr_full": GLEIF_DOWNLOAD_RR_FULL,
            },
        )
